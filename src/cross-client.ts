...
export class CrossClient {
  ...
  public async editDelegatedPubkey(
    ...
    tx.add(
      instructions.editDelegatedPubkeyV2Ix(
        delegatedPubkey,
        this.accountAddress,
        this._provider.wallet.publicKey
      )
  ...
  public createCancelOrderNoErrorInstruction(
    ...
    return instructions.cancelOrderNoErrorV3Ix(
      asset,
      this._provider.wallet.publicKey,
      this._accountAddress,
  ...
  public async cancelAllPerpMarketOrders(): Promise<TransactionSignature> {
    ...
    for (var asset of Exchange.assets) {
      ...
      tx.add(
        instructions.cancelAllMarketOrdersV3Ix(
          asset,
  ...
  public createCancelAllMarketOrdersInstruction(
    ...
    return instructions.cancelAllMarketOrdersV3Ix(
      asset,
      this._provider.wallet.publicKey,
      this._accountAddress,
      this._openOrdersAccounts[assetToIndex(asset)]
  ...
  public async cancelOrderByClientOrderId(
    ...
    let tx = new Transaction();
    let ix = instructions.cancelOrderByClientOrderIdV3Ix(
      asset,
      this._provider.wallet.publicKey,
      this._accountAddress,
      this._openOrdersAccounts[assetToIndex(asset)],
  ...
  public async cancelAndPlaceOrderByClientOrderId(
    ...
    let tx = new Transaction();
    tx.add(
      instructions.cancelOrderByClientOrderIdV3Ix(
        asset,
        this.provider.wallet.publicKey,
        this._accountAddress,
        this._openOrdersAccounts[assetIndex],
  ...
  public async replaceByClientOrderId(
    ...
    let assetIndex = assetToIndex(asset);
    tx.add(
      instructions.cancelOrderByClientOrderIdNoErrorV3Ix(
        asset,
        this._provider.wallet.publicKey,
        this._accountAddress,
        this._openOrdersAccounts[assetIndex],
  ...
  public async forceCancelOrderByOrderId(
    ...
    let tx = new Transaction();
    let ix = instructions.forceCancelOrderByOrderIdV3Ix(
      asset,
      crossMarginAccountToCancel,
  ...
  public async forceCancelOrders(
    ...
    let tx = new Transaction();
    let ix = instructions.forceCancelOrdersV3Ix(
      asset,
      crossMarginAccountToCancel,
      openOrdersAccountToCancel
    );
  ...
  public async liquidate(
    ...
    this.delegatedCheck();
    let tx = new Transaction();
    let ix = instructions.liquidateV3Ix(
      asset,
      this._provider.wallet.publicKey,
      this._accountAddress,
      Exchange.getPerpMarket(asset).address,
