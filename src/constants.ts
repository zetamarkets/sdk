...
export const ACTIVE_PERP_MARKETS = 18;
export const UNUSED_PERP_MARKETS = 7;
...
export const STATIC_AND_PERPS_LUT: {
  ...
  mainnet: new AddressLookupTableAccount({
    key: new PublicKey("FyVXxTBGYHbimS3j5G5fN63ucZb7ME9QzY7rNqnHoBFH"),
    state: {
      deactivationSlot: BigInt("18446744073709551615"),
      lastExtendedSlot: 286110606,
