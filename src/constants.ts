...
export const STATIC_AND_PERPS_LUT: {
  ...
  mainnet: new AddressLookupTableAccount({
    key: new PublicKey("J1q2UiJkJ7gKpBT3wPKrujbxMBwzQGxxsCuCP32dTrMK"),
    state: {
      deactivationSlot: BigInt("18446744073709551615"),
      lastExtendedSlot: 185096252,
      ...
      addresses: [
        ...
        new PublicKey("FknjDwDJfF9ibixsHywajQuYADrDMAJF9ERfbX6GVomC"),
        new PublicKey("FNNvb1AFDnDVPkocEri8mWbJ1952HQZtFLuwPiUjSJQ"),
        new PublicKey("11111111111111111111111111111111"),
        new PublicKey("u8iVvFmu1zFKNTN3SPuFoT7cQU7aGAEfnKpenSrm1TS"),
