...
export const FLEX_MINTS = {
  localnet: {
    ...
    [Asset.TNSR]: new PublicKey("BgDrDxc75EqPTXPUTCFMnYVYPeWK3CimPz2LGw4egsYc"),
  },
  devnet: {
    [Asset.APT]: new PublicKey("FbfkphUHaAd7c27RqhzKBRAPX8T5AzFBH259sbGmNuvG"),
    [Asset.ARB]: new PublicKey("w8h6r5ogLihfuWeCA1gs7boxNjzbwWeQbXMB3UATaC6"),
  ...
  mainnet: {
    ...
    [Asset.TNSR]: new PublicKey("7jCmRqJaJq5iojCwGqq5DdwUBYPhrpvJcgNZsFLM4Pd5"),
  },
};
...
export const PYTH_PRICE_FEEDS = {
  localnet: {
    ...
    [Asset.TNSR]: new PublicKey("Ae9pWfoS4jS8WFxMTApKHkmMaod171aRcekm1iFbsmoy"),
  },
  devnet: {
  ...
  mainnet: {
    ...
    [Asset.TNSR]: new PublicKey("H9j8CT1bFiWHaZUPMooEaxMRHdWdJ5T9CzFn41z96JHW"),
  },
};
